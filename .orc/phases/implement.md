...
- Dependencies: `github.com/urfave/cli/v3`, `modernc.org/sqlite`, `github.com/aws/aws-sdk-go-v2`, `gopkg.in/yaml.v3` beyond stdlib.
- Wrap errors with `%w` for error chains: `fmt.Errorf("loading config: %w", err)`.
- Interfaces defined in their own files, implementations in separate files.
